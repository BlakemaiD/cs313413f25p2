...
public class TestPerformance {
  ...
  public void testLinkedListAddRemove() {
    ...
    System.out.println("LinkedList Add/Remove time: " + (end - start)/1000000 + " ms");
  }
  ...
  public void testArrayListAddRemove() {
    ...
    long end = System.nanoTime();
    System.out.println("ArrayList Add/Remove time: " + (end - start)/1000000 + " ms");
  }
  ...
  //Sources used for help: https://www.tutorialspoint.com/java/lang/system_nanotime.htm
